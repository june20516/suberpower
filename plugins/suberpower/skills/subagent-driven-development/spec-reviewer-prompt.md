...
Task tool (general-purpose):
  ...
  prompt: |
    ...
    implementer는 의심스러울 만큼 빠르게 끝냈습니다. 그들의 보고서는 불완전하거나,
    부정확하거나, 낙관적일 수 있습니다. 당신은 모든 것을 독립적으로 검증해야 합니다.

    **하지 말 것:**
    - 무엇을 구현했는지에 대한 그들의 말을 그대로 받아들이는 것
    - 완전성에 대한 그들의 주장을 신뢰하는 것
    - 요구사항에 대한 그들의 해석을 수용하는 것
